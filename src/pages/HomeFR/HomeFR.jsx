...
const HomeFR = () => {
  ...
  useEffect(() => {
    const getArticles = async () => {
      const response = await fetchArticles("fr", "general");
      const techResponse = await fetchArticles("fr", "technology");
      const etResponse = await fetchArticles("fr", "entertainment");
